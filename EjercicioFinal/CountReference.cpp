...
public:
    ...
    virtual void visit(DesertPlanet*) = 0;
    virtual void visit(EarthAnalog*) = 0;
    //Singleton
    template <class T>
...
class PresentVisitor : public Visitor {
    ...
    void visit(DesertPlanet* DP) { cout << DP->getPlanet(); }
    void visit(EarthAnalog* EA) { cout << EA->getPlanet(); }
};
...
void DesertPlanet::accept(Visitor* v) { v->visit(this); }
void EarthAnalog::accept(Visitor* v) { v->visit(this); }
...
void Planet::getSpace(Spacecrafts *s) { cout << " collisions with a " << s->getSpace(); }
void Planet::getAsteroid(Asteroid *a) { cout << " collisions with a " << a->getAsteroid(); }
////////////////////////////////////////////////////////////////////////////////////////////
int main() {
